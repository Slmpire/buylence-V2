  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#F5F2ED', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{
        ...
        padding: isMobile ? '28px 16px 24px' : '40px 32px',
        textAlign: 'center',
      }}>
        <p style={{
          fontSize: isMobile ? 10 : 11, fontWeight: 700,
          letterSpacing: '0.14em', color: '#BE864B', marginBottom: 8,
        }}>
          OAU CAMPUS MARKETPLACE
        </p>
        <h1 style={{
          fontSize: isMobile ? 24 : 36, fontWeight: 900, color: 'white',
          letterSpacing: '-0.8px', marginBottom: 8, lineHeight: 1.1,
        }}>
          {isMobile ? 'Campus essentials,\ndelivered.' : 'Campus essentials,\ndelivered to your hall'}
        </h1>
      ...
      <div style={{
        ...
        padding: isMobile ? '16px 12px 64px' : '32px 28px 64px',
      }}>
        ...
        <div style={{
          ...
          alignItems: 'center', marginBottom: isMobile ? 12 : 20,
        }}>
          <p style={{ fontSize: isMobile ? 12 : 13, color: '#9C9488', margin: 0 }}>
            {loading ? 'Loading...' : (
              <>
        ...
        {loading ? (
          <div style={{
            ...
            {[...Array(isMobile ? 4 : 8)].map((_, i) => (
              <div key={i} style={{
                ...
                <div style={{ height: isMobile ? 140 : 160, backgroundColor: '#F0EDE8' }} />
                <div style={{ padding: isMobile ? 10 : 14 }}>
                  <div style={{ height: 10, backgroundColor: '#F0EDE8', borderRadius: 4, marginBottom: 6 }} />
                  <div style={{ height: 10, backgroundColor: '#F0EDE8', borderRadius: 4, width: '60%' }} />
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{ textAlign: 'center', padding: '80px 0' }}>
            ...
            <h3 style={{ fontSize: isMobile ? 15 : 16, fontWeight: 800, marginBottom: 8 }}>
        ...
        {!loading && total > 12 && (
          <div style={{
            ...
            alignItems: 'center', gap: 8, marginTop: isMobile ? 28 : 40,
          }}>
            <button
            ...
            <span style={{
              padding: '9px 12px', fontSize: isMobile ? 11 : 12,
            ...
            <button
              ...
              style={{
                ...
                color: page >= totalPages ? '#C8B89A' : '#1D1D1D',
                fontFamily: 'Inter, sans-serif',
              }}
            >
              Next →
